...
Original file is located at
    https://colab.research.google.com/drive/1E-xaXXI3ePlsLco4V7omtXxy_Btqvn3F

# Winter Break Project: Sarcasm Detection
## Data Set: [News Headlines Dataset For Sarcasm Detection](https://www.kaggle.com/datasets/rmisra/news-headlines-dataset-for-sarcasm-detection?resource=download )
"""
